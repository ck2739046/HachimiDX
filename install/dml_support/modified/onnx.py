...
class ONNXBackend(BaseBackend):
    ...
    def load_model(self, weight: str | Path) -> None:
        ...
        if self.format == "dnn":
            ...
            # HachimiDX: 通过环境变量 HACHIMIDX_DML_DEVICE_ID 精准指定 DXGI 设备序号
            import os
            _dml_device_id = os.environ.get("HACHIMIDX_DML_DEVICE_ID")
            if _dml_device_id:
                providers = [("DmlExecutionProvider", {"device_id": _dml_device_id}), "CPUExecutionProvider"]
            else:
