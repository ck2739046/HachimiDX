...
choose_backend = SN(
    ...
    nvidia_gpu_details = ", VRAM {vram} GB, SM {compute_cap}, driver {driver}",
...
pip_install = SN(
    mirror_names = {
        ...
        "pytorch_official": "Official PyTorch",
    },
...
detect_dml = SN(
    ...
    no_d3d12_gpu = "No hardware GPU supporting Direct3D 12 Feature Level 12_0 was detected. Update the GPU driver or use another backend.",
    device_unavailable = "A Direct3D 12 device supporting Feature Level 12_0 could not be created.",
